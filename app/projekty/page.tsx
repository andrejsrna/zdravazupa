      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-12">
          <section>
            ...
            <a href="https://www.health.gov.sk/Clanok?plan-obnovy" className="text-primary block mb-2">ZOBRAZIŤ VIAC</a>
            <a href="https://www.health.gov.sk/Clanok?plan-obnovy" className="text-muted-foreground">Health.gov.sk - Plán obnovy a odolnosti</a>
          </section>
