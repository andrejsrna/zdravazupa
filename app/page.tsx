            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Komplexná psychologická a sociálna podpora pre pacientov a ich rodiny.",
                ...
                <Link key={index} href={service.href}>
                  <div className="group p-6 rounded-xl border bg-white/50 backdrop-blur-sm hover:bg-white transition-all duration-300 hover:shadow-lg relative">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-2 group-hover:text-primary transition-colors">{service.name}</h3>
